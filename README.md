...
<b> 2.1. linux/MaxOS&nbsp;&nbsp;&nbsp;   [Download](https://github.com/hewm2008/NGenomeSyn/archive/v1.00.tar.gz)</b>
...
![out.png](https://github.com/hewm2008/NGenomeSyn/blob/main/Example/example3/OUT2.png)

* Example 4)  局部基因结构共线性
![out.png](https://github.com/hewm2008/NGenomeSyn/blob/main/Example/example4/OUT.png)

* Example 5)  N个基因组自由组合，任意排列

![out.png](https://github.com/hewm2008/NGenomeSyn/blob/main/Example/example5/OUT.png)


* Example 6)  任意排列
![out.png](https://github.com/hewm2008/NGenomeSyn/blob/main/Example/example6/OUT.png)
有数据可以出下图
![out.png](https://github.com/hewm2008/NGenomeSyn/blob/main/Example/example6/test.jpg)
